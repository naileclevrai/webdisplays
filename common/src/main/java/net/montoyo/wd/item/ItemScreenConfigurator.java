...
//                .tab(WebDisplays.CREATIVE_TAB)
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (CommonConfig.Screen.keepShapeOnChange) {
            origin = ScreenShape.findConnectedScreenEntity(context.getLevel(), context.getClickedPos(), side, CommonConfig.Screen.maxScreenSizeX, CommonConfig.Screen.maxScreenSizeY);
            if (origin == null) {
