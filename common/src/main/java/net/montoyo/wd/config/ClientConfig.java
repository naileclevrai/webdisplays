...
public class ClientConfig {
	...
	@Name("screen_quality")
	@Comment({
			"Scale in-world screen resolution (percent).",
			"100 = full resolution, 50 = half, 25 = quarter.",
			"Lower values improve performance at the cost of sharpness.",
	})
	@Translation("config.webdisplays.screen_quality")
	@IntRange(minV = 1, maxV = 100)
	@Default(valueI = 100)
	public static int screenQuality = 100;

	@Skip
	@Default(valueD = 1.0)
	public static double screenQualityScale = 1.0;
	...
	public static class Ambilight {
		...
		@Name("smooth_ms")
		@Comment("Transition time between ambilight colors in milliseconds (0 = instant)")
		@Translation("config.webdisplays.ambilight.smooth_ms")
		@IntRange(minV = 0, maxV = Integer.MAX_VALUE)
		@Default(valueI = 0)
		public static int smoothMs = 0;
		...
		@Name("radius")
		@Comment("Light radius multiplier (screen size * multiplier)")
	...
	public static void postLoad() {
		...
		if (Ambilight.smoothMs < 0)
			Ambilight.smoothMs = 0;
		...
		screenQualityScale = screenQuality / 100.0;
		if (WebDisplays.PROXY != null)
			WebDisplays.PROXY.onScreenQualityChanged();
